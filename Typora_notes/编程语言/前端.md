...
> - 目前的笔记都是html4的语法，h5的新增项，比如：上传文件
...
<fieldset>
    <legend>主要信息</legend>
    <label for="zhanghu">账户：<input id="zhanghu" type="text" name="account" 					value="zhangsan" maxlength="10">
    </label>
	<br>
</fieldset>
```
...
> 可以嵌入其他网页，frameborder的值只能是1或者0
>
> 可以嵌入广告

```html
<iframe src="https://search.jd.com" frameborder="1"></iframe>
```

> 超链接的target 和 iframe配合

```html
<a href="https://www.taobao.com/" target="tt">点我看淘宝</a>
<a href="https://www.bilibili.com/" target="tt">点我看b站</a>
<iframe name="tt" frameborder="1"></iframe>
```
