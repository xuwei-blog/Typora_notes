...
| 07C00    | 07DFF    | 512B    | MBR被BIOS加载到此处，jmp 0x0:0x7C00 ，一个存有MBR可执行程序的扇区刚好512B |
...
> jmp 0xf000:0xe05b
>
> 段基址 X 16 +  段内偏移量 e05b  = 0x fe05b   ，该内存属于bios程序
...
> MBR，又名Master Boot Record，即主引导记录，也被称为主引导扇区，主要记录着硬盘本身的相关信息以及硬盘各个分区的大小及位置信息



- 魔数

> 一种文件系统对应一个魔数，比对此值便知道文件系统类型
>
> linux中的 file指令
